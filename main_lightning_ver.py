# save as main_lightning_final.py
...
plt.title("Accuracy vs Hidden Dim (Lightning)")
plt.legend()
plt.grid(True)
plt.savefig("lightning_hidden_dim_sweep.png")
plt.show()

# ========== PHASE 2–3: Trials + Bootstrap ==========
...
for k in [2, 4, 8]:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"lightning_bootstrap_ci_k{k}.png")
    plt.show()